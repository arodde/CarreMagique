...
namespace CarreMagique
{
    public class Persistance
    {
        ...
        // ancienne version sour .NET Core 2.1
        ...
        //    
        //    //sous .Net 2.1 avec newtonJson non maintenu
        //    //grille.Damier = JsonConvert.DeserializeObject<Grille>(sGrilleJSON).Damier;
        //    foreach (Cellule cell in persistanceGrille.Damier)
        //    {
        //        cell.IValeur = grille.Damier[i, j].IValeur;
        //        j++;
        //        if (j == persistanceGrille.INombre)
        //        {
        //            i++;
        ...
        public void OuvrirFichierJSON(string sCheminFichier)
        {
           ...
           //XXX
           //TODO ???
            // 2021/12/08 sous .Net 5.0
            grille.Damier = JsonSerializer.Deserialize<Grille>(sGrilleJSON).Damier;
        ...
        // TODO ???
            ...
            string jsonSerializedObj = JsonSerializer.Serialize(persistanceGrille, options);
